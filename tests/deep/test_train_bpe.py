...
FIXTURES_PATH = (pathlib.Path(__file__).resolve().parent.parent.parent) / "data"
...
def test_train_bpe_owt_vaild():
    print(f"[BEGIN] {get_current_time()}")
    ...
    print(f"[FINISH] {get_current_time()}")
    assert True
